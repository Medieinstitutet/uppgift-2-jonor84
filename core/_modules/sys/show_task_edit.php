...
if ($gloAccess < 7) {
  ...
  if ($rowDone) { 
    echo "<div class='$alertInfo text-dark'><h4><i class='fas fa-info-circle'></i> Denna uppgift är redan hanterad.</h4> <a class='btn btn-light' href='$gloBaseModule&show=task_show&id=$rowID'>Visa den hanterade uppgiften <i class='fas fa-arrow-circle-right'></i></a></div>";
    ...
    <div class="col-xl-12 col-md-6 mb-4">
      <div class="card shadow mb-4">
        ...
        <div class="card-body">
          ...
          <form method="post" class="form-horizontal" action="<? echo $gloBaseModule; ?>&task=task_edit">
            <input type="hidden" name="frmTID" value="<? echo $rowID; ?>">
              ...
              <table class="table table-striped" style="white-space:nowrap; margin-bottom: 0px;" width="100%">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <? if ($rowDone == 1) {
                        $ActiveService = "checked";
                      } else {
                        $ActiveService = "";
                      } ?>
                      <label class="custom-switch"> <span class="custom-switch-description">Pågående &nbsp;</span>
                        <input type="checkbox" name="frmDone" class="custom-switch-input"></input>
                        <span class="custom-switch-indicator"></span> <span class="custom-switch-description">Slutförd</span> </label>
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td><textarea class="form-control" rows="5" name="frmANotes"><? echo $rowANotes; ?></textarea></td>
                  </tr>
