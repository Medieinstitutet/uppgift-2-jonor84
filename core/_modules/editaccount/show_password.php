    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="card mb-4">
                ...
                <div class="card-body">
                <div class='alert alert-info text-dark p-3'><i class="fas fa-info-circle"></i> Alla fält markerade med en asterisk (*) är obligatoriska.</div>

                    <form method="post" class="form-horizontal" action="<? echo $gloBaseModule; ?>&task=password">
                        <div class="form-group mb-4">
                            <h4>Datum f&ouml;r senaste byte:</h4>
                            <p class="form-control-static text-muted"><? echo $rowDate; ?></p>
                        </div>
                        <div class="form-group mb-3">
                            <h4>Nuvarande lösenord: *</h4>
                            <input type="password" id="inputStandard" class="form-control" name="frmPW0">
                        </div>
