...
$UserFirstName = UserFirstName($gloUID);
 ...
 addCodeAuth($Sendtype, $EmailPosted, $gloUID, $CODE);
...
$MailSent = sendMailPM($EmailPosted, $UserFirstName, $Subject, $Message, $gloUID);
    ...
    <div class="col-xl-12 col-md-6 mb-4">
      <div class="card mb-4">
        ...
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
          <h3 class="m-0 font-weight-bold brand-title"><? echo $strHeader; ?> / Ändra E-postadress 2/2</h3>
        </div>
        <!-- Card Body -->
        <div class="card-body">
          <form method="post" class="form-horizontal" action="<? echo $gloBaseModule; ?>&task=email">
                <input type="hidden" name="frmUser" value="<?php echo htmlspecialchars($EmailPosted); ?>">
