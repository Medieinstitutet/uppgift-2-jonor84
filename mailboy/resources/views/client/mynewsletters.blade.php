                            ...
                            <ul>
                                ...
                                <li class="py-3 flex justify-between items-center">
                                    ...
                                    <div class="flex space-x-2">
                                        <a href="{{ route('client.edit-newsletter', $newsletter->id) }}" class="text-indigo-600 hover:text-indigo-900 mr-2"><i class="bi bi-pencil"></i></a>
                                        <form action="{{ route('client.destroy-newsletter', $newsletter->id) }}" method="POST" class="inline">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="text-red-600 hover:text-red-900"><i class="bi bi-trash3"></i></button>
                                        </form>
                                    </div>
                                </li>
                                <hr>
